...
import {getRelationshipNode} from "./getRelationshipNode";
...
export class RelationshipNode extends DecoratorBlockNode {
  ...
  decorate(editor: LexicalEditor, config: EditorConfig): JSX.Element {
    return getRelationshipNode(config.theme.relationship ?? 'LexicalEditorTheme__relationship', this.__data, this.__format, this.getKey())
  }
